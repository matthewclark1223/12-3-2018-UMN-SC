...
venue: "University of Minnesota, Minneapolis"        # brief name of host site without address (e.g., "Euphoric State University")
address: "Walter Library, 117 Pleasant St. SE, Room 101, Minneapolis, MN 55455"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
latlng: "44.975320,-93.236408"       # decimal latitude and longitude of workshop venue (e.g., "41.7901128,-87.6007318" - use https://www.latlong.net/)
humandate: "Dec 3-4, 2018"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
instructor: ["Matt Clark","Jon Badalamenti"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Cody Hennesy (Dec 3)","Peter Wiringa (Dec 3)","Nick Dunn (Dec 4)","Alicia Hofelich Mohr (Dec 4)","Seth Mayotte (Dec 4)"]     
email: ["fdsayre@umn.edu"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
collaborative_notes:    https://pad.carpentries.org/UMN_SWC_DASH1         # optional: URL for the workshop Etherpad or Google Docs document
eventbrite: "51669978296"     # optional: alphanumeric key for Eventbrite registration, e.g., "1234567890AB" (if Eventbrite is being used)
---
 <p id="intro">
  <strong>Intro:</strong>
